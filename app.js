...
function fillEditor(){
 ...
 $("#eSkills").value=data.skills.join("\n");$("#eEmail").value=data.contact.email||"";$("#ePhone").value=data.contact.phone||"";$("#eFacebook").value=data.contact.facebook||"";$("#eLinkedin").value=data.contact.linkedin||"";$("#eGithub").value=data.contact.github||"";$("#eContactText").value=data.contact.text||"";
